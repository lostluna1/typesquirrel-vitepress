import{_ as a,c as i,o as n,ae as p}from"./chunks/framework.C5fWPVDY.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"classes/AttackInfoPacket.md","filePath":"classes/AttackInfoPacket.md"}'),l={name:"classes/AttackInfoPacket.md"};function t(k,s,h,e,A,r){return n(),i("div",null,[...s[0]||(s[0]=[p(`<div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div>`,1)])])}const D=a(l,[["render",t]]);export{d as __pageData,D as default};
