import{_ as i,c as a,o as n,ae as l}from"./chunks/framework.C5fWPVDY.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"classes/IRDActiveObject.md","filePath":"classes/IRDActiveObject.md"}'),h={name:"classes/IRDActiveObject.md"};function k(p,s,t,e,r,g){return n(),a("div",null,[...s[0]||(s[0]=[l(`<div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
